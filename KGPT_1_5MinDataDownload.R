...
for (month in 1:12) {
  ...
  url_1min <- paste0(url_base_1min, "2022/", sprintf("%02d", month), "/asos-1min-pg1-KGPT-2022", sprintf("%02d", month), ".dat")
  file_name_1min <- paste0("64050KGPT2022", sprintf("%02d", month), ".dat")
  ...
  url_5min <- paste0(url_base_5min, "2022/", sprintf("%02d", month), "/asos-5min-KGPT-2022", sprintf("%02d", month), ".dat")
  file_name_5min <- paste0("64010KGPT2022", sprintf("%02d", month), ".dat")
